						...
						<View style={styles.videoInfoContainer}>
							<View style={styles.infoTopContainer}>
								...
								<TouchableOpacity activeOpacity={1} style={styles.infoRight} onPress={() => { !this.state.isVote && this._clickVote() }}>
									<Image style={styles.infoZoveImg} source={this.state.isVote ? require('./images/i_vote_red.png') : require('./images/i_vote_black.png')} resizeMode={'contain'} />
							...
							<View style={styles.vedioPlayContainer}>
								<Image resizeMode={'contain'} source={require('./images/i_right_arrows.png')} style={{ width: 15, height: 15 }} />
